      ...
      <div class="main">
        <div class="wrapper-content">
          ...
          <network-result-view
            ...
            :networkResult="movieNetworkResult"
          >
...
import { useCaseGetPopularMovies } from "@/injection";
...
export default defineComponent({
  ...
  data: () => {
    const movieNetworkResult: NetworkResult<[Movie[], number]> =
      new ResultEmpty();
  ...
  methods: {
    ...
    onParamChanged() {
      if (this.$route.name == "MovieListScreen") {
